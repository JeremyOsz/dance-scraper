...
const organizerUrl = "https://www.eventbrite.com/o/79771578413";
...
export async function scrapeRachelMannMarlonWhoHenry(): Promise<AdapterOutput> {
  try {
    ...
    return {
      venueKey: "rachelMannMarlonWhoHenry",
      venue: "Rachel Mann & Marlon Who Henry",
      sourceUrl: organizerUrl,
